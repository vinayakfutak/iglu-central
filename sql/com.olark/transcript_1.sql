...
CREATE TABLE IF NOT EXISTS atomic.com_olark_transcript_1 (
    ...
    "operators..*.email_address"           VARCHAR(256)  ENCODE LZO,
    "operators..*.id"                      VARCHAR(128)  ENCODE LZO,
    "operators..*.kind"                    VARCHAR(64)   ENCODE LZO,
    "operators..*.nickname"                VARCHAR(64)   ENCODE LZO,
    "operators..*.username"                VARCHAR(128)  ENCODE LZO,
